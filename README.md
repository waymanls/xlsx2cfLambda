...
```bash
xlsx2cfLambda$ pip install -r tests/requirements.txt --user
# unit test
xlsx2cfLambda$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
xlsx2cfLambda$ AWS_SAM_STACK_NAME=<stack-name> python -m pytest tests/integration -v
```
...
```bash
aws cloudformation delete-stack --stack-name xlsx2cfLambda
```
